...
// (Pacman + Ghost classes remain EXACTLY the same)
// --- Paste your existing Pacman and Ghost classes here unchanged ---
// --- main() also unchanged except we now have maze.adjList usable for BFS/Dijkstra ---
